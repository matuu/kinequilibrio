...
@register.inclusion_tag('kine_blog/tags/top_menu.html', takes_context=True)
...
@register.inclusion_tag('kine_blog/tags/top_menu_children.html', takes_context=True)
...
#@register.inclusion_tag('kine_blog/tags/secondary_menu.html', takes_context=True)
...
#@register.inclusion_tag(
    #'kine_blog/tags/standard_index_listing.html',
    #takes_context=True
#)
...
#@register.inclusion_tag(
    #'kine_blog/tags/person_listing_homepage.html',
    #takes_context=True
#)
...
@register.inclusion_tag(
    'kine_blog/tags/blog_listing_homepage.html',
    takes_context=True
)
...
#@register.inclusion_tag(
    #'kine_blog/tags/event_listing_homepage.html',
    #takes_context=True
#)
...
# Advert snippets
#@register.inclusion_tag('kineblog/tags/adverts.html', takes_context=True)
#def adverts(context):
    #return {
