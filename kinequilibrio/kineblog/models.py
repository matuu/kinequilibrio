...
class ContactFields(models.Model):
    ...
    panels = [
        FieldPanel('telefono'),
        FieldPanel('email'),
        FieldPanel('direccion_1'),
        FieldPanel('direccion_2'),
        FieldPanel('ciudad'),
        FieldPanel('provincia'),
        FieldPanel('pais'),
        FieldPanel('codigo_postal'),
    ]
...
class AdvertPlacement(models.Model):
    ...
    advert = models.ForeignKey('kineblog.Advert', related_name='+')
...
class HomePageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('kineblog.HomePage', related_name='carousel_items')


class HomePageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('kineblog.HomePage', related_name='related_links')
...
class StandardIndexPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('kineblog.StandardIndexPage', related_name='related_links')
...
class StandardPageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('kineblog.StandardPage', related_name='carousel_items')


class StandardPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('kineblog.StandardPage', related_name='related_links')
...
class BlogIndexPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('kineblog.BlogIndexPage', related_name='related_links')
...
class BlogPageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('kineblog.BlogPage', related_name='carousel_items')


class BlogPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('kineblog.BlogPage', related_name='related_links')


class BlogPageTag(TaggedItemBase):
    content_object = ParentalKey('kineblog.BlogPage', related_name='tagged_items')
...
class PersonPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('kineblog.PersonPage', related_name='related_links')
...
class EventIndexPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('kineblog.EventIndexPage', related_name='related_links')
...
class EventPageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('kineblog.EventPage', related_name='carousel_items')


class EventPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('kineblog.EventPage', related_name='related_links')


class EventPageSpeaker(Orderable, LinkFields):
    page = ParentalKey('kineblog.EventPage', related_name='speakers')
