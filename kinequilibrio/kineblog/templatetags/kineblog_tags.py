...
@register.inclusion_tag('kineblog/tags/top_menu.html', takes_context=True)
...
@register.inclusion_tag('kineblog/tags/top_menu_children.html', takes_context=True)
...
@register.inclusion_tag('kineblog/tags/secondary_menu.html', takes_context=True)
...
@register.inclusion_tag(
    'kineblog/tags/person_listing_homepage.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'kineblog/tags/blog_listing_homepage.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'kineblog/tags/event_listing_homepage.html',
    takes_context=True
)
