...
ROOT_URLCONF = 'kinequilibrio.urls'
WSGI_APPLICATION = 'kinequilibrio.wsgi.application'
TEMPLATE_DIRS = ()
...
EMAIL_SUBJECT_PREFIX = '[kinequilibrio] '
...
# WAGTAIL SETTINGS
WAGTAIL_SITE_NAME = 'kinequilibrio'

# Override the search results template for wagtailsearch
WAGTAILSEARCH_RESULTS_TEMPLATE = 'kineblog/search_results.html'
